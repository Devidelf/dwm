...
static const char *fonts[]          = { "FiraCode NerdFont:size=11" };
static const char dmenufont[]       = "FiraCode NerdFont:size=11";
...
/* key definitions */
#define MODKEY ControlMask|ShiftMask|Mod4Mask|Mod1Mask
